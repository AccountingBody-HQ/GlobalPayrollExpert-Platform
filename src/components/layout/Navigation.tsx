          ...
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/" className="flex items-center gap-2.5 shrink-0 group" aria-label="HRLake home">
              ...
              <div className="hidden sm:flex flex-col leading-none">
                <span className="font-bold text-navy-900 text-sm tracking-tight">GlobalPayroll</span>
                <span className="font-bold text-blue-500 text-sm tracking-tight">Expert</span>
              </div>
            </Link>
