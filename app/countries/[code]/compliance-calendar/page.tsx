          ...
          <div className="flex flex-wrap items-start justify-between gap-6">
            <div className="max-w-2xl">
              ...
              <h1 className="font-serif text-3xl lg:text-5xl font-bold text-white leading-tight mb-4" style={{ letterSpacing: '-0.025em' }}>
                {getFlag(country.iso2)} Compliance Calendar<br /><span className="text-blue-400">{country.name}</span>
              </h1>
            ...
            <div className="space-y-5">
              ...
              <div className="rounded-2xl p-6 overflow-hidden relative" style={{ backgroundColor: '#0d1f3c' }}>
                ...
                <div className="relative">
                  ...
                  <h3 className="font-serif text-lg font-bold text-white mb-2 leading-snug">Full compliance calendars across all active countries.</h3>
